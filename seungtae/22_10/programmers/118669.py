...
# 테스트 13 〉	통과 (5.54ms, 11.8MB)
# 테스트 14 〉	통과 (61.44ms, 19.8MB)
# 테스트 15 〉	통과 (601.54ms, 74.5MB)
# 테스트 16 〉	통과 (392.12ms, 77.1MB)
# 테스트 17 〉	통과 (403.62ms, 77.1MB)
# 테스트 18 〉	통과 (64.40ms, 16.4MB)
# 테스트 19 〉	통과 (117.37ms, 36.6MB)
# 테스트 20 〉	통과 (513.29ms, 89.9MB)
# 테스트 21 〉	통과 (712.31ms, 78.6MB)
# 테스트 22 〉	통과 (28.41ms, 15.6MB)
# 테스트 23 〉	통과 (125.92ms, 34.5MB)
# 테스트 24 〉	통과 (121.16ms, 30.9MB)
# 테스트 25 〉	통과 (431.88ms, 93.3MB)